<%-- 
    Document   : Footer
    Created on : Dec 25, 2023, 8:17:17 PM
    Author     : Admin
--%>
    ...
    <div class="container">
        <div class="row">       
            ...
            <div class="col-md-4 col-lg-4 col-xl-4 mx-auto">
                ...
                <hr class="bg-white mb-2 mt-0 d-inline-block mx-auto w-25">
               <!--đoạn mã này tạo ra một iframe nhúng một plugin Facebook có kích thước cụ thể và các tính năng tùy chỉnh, cho phép bạn hiển thị nội dung từ trang Facebook trên trang web của mình một cách dễ dàng.-->
