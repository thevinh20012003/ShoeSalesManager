<%-- 
    Document   : Menu
    Created on : Dec 25, 2023, 8:00:15 PM
    Author     : Admin
--%>
...
<nav class="navbar navbar-expand-md navbar-dark bg-dark" style="position: fixed; top: 0; width:100%;  z-index: 100000;">
    <div class="container">
        ...
        <div class="collapse navbar-collapse justify-content-end" id="navbarsExampleDefault">
            ...
            <!--đoạn mã này mô tả một form tìm kiếm và một nút giỏ hàng. Khi người dùng nhấp vào nút giỏ hàng, họ có thể được chuyển hướng đến trang quản lý giỏ hàng (managerCart).-->
